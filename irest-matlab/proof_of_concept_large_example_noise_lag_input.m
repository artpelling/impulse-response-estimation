...
% Generate input -> Let's use noise. This leads to an ill-conditioned A
% (see line 104). We can pre-condition, by adding a geometric sequence
% generated by the Laguerre parameter a.
c0 = 100;
u = c0.*conj(a).^(0:N-1);
