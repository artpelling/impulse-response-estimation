function bts = biort_system(len, mpoles)

% BIORT_SYSTEM - Generates the biorthogonal system.
%
% Usage: 
...
%
% Output parameters:
%     bts : the elements of the biorthogonal system at the uniform 
...
for j = 1:length(multi)
    for k=1:multi(j);
        ...
        bts(col,:)=pszi(j,k,spoles,multi,z);
    end    
end
